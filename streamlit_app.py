...
st.title("Classipet")
st.write("Clasificador de mascotas, Introduzca los dato de su mascota y le diremos a que clase pertenece.")
st.image("img/animales.jpg", use_container_width=True)
...
# Extrae los valores categoricos
